...
# docker login
# docker buildx build --platform "linux/amd64,linux/arm64,linux/arm/v7" -t jackietreehorn/mongo-replica-ctrl:1.01 -t jackietreehorn/mongo-replica-ctrl:latest --push .
